...
// SiteConfigV1 and ClusterCRsV1 are deprecated use SiteConfigV2 and ClusterCRsV2 to add new field.
// SiteConfigV1 uses clusterCRsV1 to generate the required CRs for cluster provisioning

const siteConfigAPIV1 = siteConfigAPIGroup + "/v1"
